...
export class GithubVersionSwitcher {
  ...
  static get is() { return "github-version-switcher"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["github-version-switcher.scss"]
    };
  }
  static get styleUrls() {
    return {
      "$": ["github-version-switcher.css"]
    };
  }
  static get properties() {
    return {
      "owner": {
        ...
        "docs": {
          "tags": [],
          "text": "Provides the owner of the repo"
        },
        "attribute": "owner",
        "reflect": false
      },
      "repo": {
        ...
        "docs": {
          "tags": [],
          "text": "Provides the name of the repo"
        },
        "attribute": "repo",
        "reflect": false
      }
...
//# sourceMappingURL=github-version-switcher.js.map
