...
export const LiveDemo = ({ ariaexpanded, ariapressed, disabled, formaction, formenctype, formmethod, formnovalidate, formtarget, icon, iconafter, icononly, name, text, tooltip, type, value, variant }) => {
  return `<db-button
...
//# sourceMappingURL=db-button.demo.stories.js.map
