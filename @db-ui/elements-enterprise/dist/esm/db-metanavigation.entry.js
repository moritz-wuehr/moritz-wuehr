import { r as registerInstance, h, H as Host, g as getElement } from './index-8b4f8b96.js';
import { p as parseData, g as getDefaultLinkData } from './utils-8fa1298c.js';
...
const DbMetanavigation = class {
  ...
  render() {
    return (h(Host, null, this.compData && (h("ul", { class: "cmp-metanavigation", innerHTML: getDefaultLinkData(this.compData) })), !this.compData && (h("ul", { class: "cmp-metanavigation" }, !this.hasItemsWrapper &&
      this._children.map((child, index) => (h("li", { key: `cmp-metanavigation-item-${index}`, innerHTML: child.outerHTML }))), this.hasItemsWrapper && h("slot", null)))));
  }
  get host() { return getElement(this); }
};
DbMetanavigation.style = dbMetanavigationCss;

export { DbMetanavigation as db_metanavigation };

//# sourceMappingURL=db-metanavigation.entry.js.map