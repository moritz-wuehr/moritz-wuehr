...
const DbBreadcrumb = class {
  ...
  render() {
    return (index.h("nav", { class: "cmp-breadcrumb", "aria-label": this.arialabel }, this.compData && index.h("ol", { innerHTML: getCompDataHtml(this.compData) }), !this.compData && (index.h("ol", null, !this.hasItemsWrapper &&
      this._children.map((child, index$1) => (index.h("li", { key: `cmp-breadcrumb-item-${index$1}`, innerHTML: child.outerHTML }))), this.hasItemsWrapper && index.h("slot", null)))));
  }
  get host() { return index.getElement(this); }
};
DbBreadcrumb.style = dbBreadcrumbCss;

exports.db_breadcrumb = DbBreadcrumb;

//# sourceMappingURL=db-breadcrumb.cjs.entry.js.map