...
const getJsxLinks = (items) => {
  return items.map((item, index$1) => (index.h("li", { key: `mainnavigation-item-${index$1}`, innerHTML: item.html }, item.children && index.h("ul", null, getJsxLinks(item.children)))));
};
...
const DbMainnavigation = class {
  ...
  render() {
    return (index.h("nav", { class: "cmp-mainnavigation", id: "mainnavigation" }, index.h("input", { type: "checkbox", id: "toggle_mainnavigation" }), index.h("label", { htmlFor: "toggle_mainnavigation", title: "Toggle main navigation", class: "is-site-name" }, this.siteName), this.compData && index.h("ul", { innerHTML: getCompDataHtml(this.compData) }), !this.compData && (index.h("ul", null, this.onlyLinks && getJsxLinks(this.onlyLinks), !this.hasItemsWrapper &&
      !this.onlyLinks &&
      this.children.map((child, index$1) => (index.h("li", { key: `cmp-mainnavigation-item-${index$1}`, innerHTML: child.outerHTML }))), this.hasItemsWrapper && index.h("slot", null)))));
  }
  get host() { return index.getElement(this); }
};
DbMainnavigation.style = dbMainnavigationCss;

exports.db_mainnavigation = DbMainnavigation;

//# sourceMappingURL=db-mainnavigation.cjs.entry.js.map