...
export class DbCard {
  ...
  render() {
    return (h("div", { class: "cmp-card", "data-variant": this.variant }, h("figure", null, this.illustration && (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "64", height: "64", "aria-hidden": "true" }, h("use", { href: `${this.uiCoreIllustrationPath}/${this.illustrationPaths[this.illustration]}#icon` }))), !this.illustration && this.image && (h("img", { src: this.image, height: "64", width: "64", alt: this.alt })), h("figcaption", null, this.header && h("db-headline", null, this.header), this.content && h("p", null, this.content), !this.header && !this.content && h("slot", null)))));
  }
