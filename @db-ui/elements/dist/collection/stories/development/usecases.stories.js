...
if (!customElements.get('a-component')) {
  customElements.define('a-component', class extends HTMLElement {
    constructor() {
      super();
...
if (!customElements.get('aa-component')) {
  customElements.define('aa-component', class extends HTMLElement {
    constructor() {
      super();
      const template = document.createElement('template');
      template.innerHTML = `
...
//# sourceMappingURL=usecases.stories.js.map
