...
const DbCard = class {
  ...
  render() {
    return (index.h("div", { class: "cmp-card", "data-variant": this.variant }, index.h("figure", null, this.illustration && (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "64", height: "64", "aria-hidden": "true" }, index.h("use", { href: `${this.uiCoreIllustrationPath}/${this.illustrationPaths[this.illustration]}#icon` }))), !this.illustration && this.image && (index.h("img", { src: this.image, height: "64", width: "64", alt: this.alt })), index.h("figcaption", null, this.header && index.h("db-headline", null, this.header), this.content && index.h("p", null, this.content), !this.header && !this.content && index.h("slot", null)))));
  }
};
DbCard.style = dbCardCss;
