...
const DbBrand = class {
  ...
  render() {
    return (index.h("div", { class: "cmp-brand" }, index.h("a", { href: this.anchorRef, title: this.anchorTitle, rel: this.anchorRelation }, index.h("img", { src: this.src, alt: this.alt, class: "elm-image is-logo" }), this.siteNameLink && (index.h("span", { class: "is-site-name" }, index.h("slot", null)))), !this.siteNameLink && (index.h("span", { class: "is-site-name" }, index.h("slot", null)))));
  }
};
DbBrand.style = dbBrandCss;

exports.db_brand = DbBrand;

//# sourceMappingURL=db-brand.cjs.entry.js.map