...
const DbCards = class {
  ...
  render() {
    return (index.h("div", { class: "cmp-cards" }, index.h("slot", null)));
  }
};
DbCards.style = dbCardsCss;

exports.db_cards = DbCards;

//# sourceMappingURL=db-cards.cjs.entry.js.map