...
const GithubVersionSwitcher = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, null, ((_a = this.groups) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("db-select", { class: "gh-version-switcher", label: "Version", name: "Theme", onDbChange: (event) => this.handleChange(event.target.value, this.cleanOwner, this.cleanRepo) }, index.h("option", { value: this._defaultBranch, selected: this.currentBranch === this._defaultBranch }, this._defaultBranch), this.groups
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
